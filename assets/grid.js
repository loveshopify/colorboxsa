...
var intersection_observer = __webpack_require__(9);
...
var script = __webpack_require__(6);
...
var jquery_trend = __webpack_require__(1);
...
var ProductMasonry_ProductMasonry =
/*#__PURE__*/
function () {
...
function () {
  ...
  VariantHelper_createClass(VariantHelper, [{
    ...
    value: function _updateImages(variant) {
      ...
      var $thumbById = this.options.$productThumbnails.filter("[data-image-id='".concat(imageId, "']"));
      var $thumbByIndex = this.options.$productThumbnails.filter("[data-image-position='".concat(imagePosition, "']"));

      if (imageId != null && $thumbById.length) {
        $thumbById.trigger('click');
      } // Support for QuickShop which isn't able to support image ids
    ...
    key: "_updateCurrency",
    value: function _updateCurrency() {
      if (Theme.enable_currency_converter) {
        return $('[data-currency-converter]').trigger('updateCurrency', this.options);
      }
    }
  }]);
...
function () {
  function ImageZoom(component) {
    ...
    this.$el = $(component.el);
    this.zoomArea = $('.product-zoom');
    this.zoomAreaContainer = $('.product-main-image');
  ...
  ImageZoom_createClass(ImageZoom, [{
    key: "prepareZoom",
    value: function prepareZoom(image) {
      var _this = this;
...
var ProductSlideshow_ProductSlideshow =
/*#__PURE__*/
function () {
  function ProductSlideshow(component) {
    ...
    this.productThumbnailsWrapper = this.$images.find('.product-thumbnails-wrapper');
    this.productThumbnails = this.$images.find('.product-thumbnails');
    this.productThumbnail = this.$images.find('.product-thumbnail');
    dist_index_es.watch(component.el[0]);
    component.el.on("rimg:load", function () {
      return _this.setupProductSlideshow();
    });
  ...
  ProductSlideshow_createClass(ProductSlideshow, [{
    ...
    value: function setupProductSlideshow() {
      ...
      for (var i = 0; i < this.productThumbnail.length; i++) {
        ...
        var currentImageWidth = image.getBoundingClientRect().width;
    ...
    value: function moveProductThumbnails(e) {
      ...
      var currentPosition = this.productThumbnails.position().left;
...
var grouped_content_dist = __webpack_require__(7);
...
var fitvids = __webpack_require__(0);
...
function () {
  ...
  RTE_createClass(RTE, [{
    ...
    value: function setupTabs() {
      return new grouped_content_dist_default.a(this.$el.get(0), {
        layout: 'tabs',
        intelliparse: false
      });
    }
    ...
    value: function resizeVideos() {
      ...
      var videos = $('iframe', this.$el);

      for (var i = 0; i < videos.length; i++) {
        var video = videos[i];

        if (video.hasClass('highlight')) {
          video.parent().addClass('highlight');
        }
      }
    }
  }]);
...
function () {
  function Product(el, options) {
    ...
    if (this.imagesLayout === 'slideshow') {
      this.productSlideshow = new ProductSlideshow_ProductSlideshow({
      ...
      this.productMasonryLayout = new ProductMasonry_ProductMasonry({
        el: this.$productContainer
      });
    }

    if (this.imagesLayout === 'slideshow' && this.enableZoom) {
      var imageId = this.productMainImage.find('img').data('image-id');
      this.zoomView = new ImageZoom({
        el: $(this.images[imageId])
      });
    }
    ...
    this.$productThumbnails.on('click', function (event) {
    ...
    if (Theme.enable_currency_converter) {
      $('[data-currency-converter]').trigger('updateCurrency');
    }
  ...
  Product_createClass(Product, [{
    ...
    value: function unload() {
      ...
      if (this.productSlideshow != null) {
        this.productSlideshow = null;
      }

      if (this.productMasonryLayout != null) {
    ...
    key: "swapProductImage",
    value: function swapProductImage(e) {
      var imageId = $(e.target, this.$el).data('image-id');
      var $nextImage = $(this.images[imageId]);
      $nextImage.css('display', 'none');
      var $image = $('[data-product-main-image]', this.$el);
      ...
      if (this.zoomView != null) {
        this.zoomView.prepareZoom($nextImage);
      }
    }
  }, {
    ...
    value: function addToCart(e) {
      ...
      $.post('/cart/add.js', this.$productForm.serialize(), null, 'json').done(function (item) {
        var message = Theme.addToCartSuccess.replace('**product**', item.title).replace('**cart_link**', "<a href=\"/cart\">".concat(_this2.labels.cartLink, "</a>")).replace('**continue_link**', "<a href=\"/collections/all\">".concat(_this2.labels.continueLink, "</a>")).replace('**checkout_link**', "<a href=\"/checkout\">".concat(_this2.labels.checkoutLink, "</a>"));
    ...
    value: function updateCart(newItem) {
      ...
      var miniCartItemWrapper = $('.mini-cart-item-wrapper');
      var labels = this.labels;
      Shopify.getCart(function (cart) {
        miniCartItemWrapper.empty();
        $('[data-cart-count]').html("<span class=\"cart-count-text\">\n          ".concat(labels.cartHeaderText, "</span>\n          (<span class=\"cart-count-number\">").concat(cart.item_count, "</span>)"));
        ...
        var currencySwitcher = $('[data-currency-converter]');
...
var ProductListItem_ProductListItem =
/*#__PURE__*/
function () {
...
function () {
  ...
  DynamicCollectionsList_createClass(DynamicCollectionsList, [{
    ...
    value: function _bindEvents() {
      ...
      $(window).on('resize.collections-view', function () {
        _this._setupCollections();

        if (!Modernizr.csstransforms) {
          _this._centerCollectionText();
        }
      });
    }
  }, {
    ...
    value: function _setupCollections() {
      ...
      $.each(featuredCollectionImages, function (index, collectionImage) {
        ...
        if (collectionImageHeight < _this2.collectionHeight) {
    ...
    key: "_centerCollectionText",
    value: function _centerCollectionText() {
      var collectionText = $('.home-collection-overlay', this.$collectionsContainer);

      for (var i = 0; i < collectionText.length; i++) {
        var collectionTextEl = $(collectionText[i]);
        var textHeight = collectionTextEl.height();
        var textWidth = collectionTextEl.outerWidth();
        collectionTextEl.css({
...
var DynamicFeaturedCollection_DynamicFeaturedCollection =
/*#__PURE__*/
function () {
...
var DynamicMasonry_DynamicMasonry =
/*#__PURE__*/
function () {
...
var DynamicPromotion_DynamicPromotion =
/*#__PURE__*/
function () {
...
// CONCATENATED MODULE: ./source/scripts/sections/InstagramWidget.js
function InstagramWidget_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function InstagramWidget_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function InstagramWidget_createClass(Constructor, protoProps, staticProps) { if (protoProps) InstagramWidget_defineProperties(Constructor.prototype, protoProps); if (staticProps) InstagramWidget_defineProperties(Constructor, staticProps); return Constructor; }

var InstagramWidget =
/*#__PURE__*/
function () {
  function InstagramWidget(section) {
    InstagramWidget_classCallCheck(this, InstagramWidget);
  ...
  InstagramWidget_createClass(InstagramWidget, [{
    key: "_validate",
    value: function _validate() {
      this.$photoContainer = $('[data-instagram-photos]', this.$el);
      var accessToken = $('[data-instagram-token]', this.$el).attr('data-instagram-token');
      var photoCount = $('[data-instagram-photo-count]', this.$el).attr('data-instagram-photo-count');
      var isInitialized = this.$el.hasClass(this.initializedClass);
      return this._getPhotos(accessToken, photoCount, isInitialized);
    }
  }, {
    key: "_getPhotos",
    value: function _getPhotos(accessToken, photoCount, isInitialized) {
      var _this = this;
      ...
      var url = "https://api.instagram.com/v1/users/self/media/recent?access_token=".concat(accessToken, "&count=").concat(photoCount, "&callback=");
      return $.ajax({
        type: 'GET',
        dataType: 'jsonp',
        url: url,
        success: function success(response) {
          if (response.meta.code === 200) {
            ...
            for (var i = 0; i < response.data.length; i++) {
              ...
              if (photo && photo.images && photo.images.standard_resolution && photo.images.standard_resolution.url) {
                result.push(_this.$photoContainer.append("                <a\n                class=\"instagram-photo\"\n                target=\"_blank\"\n                href=\"".concat(photo.link, "\"\n                style=\"background-image: url('").concat(photo.images.standard_resolution.url, "')\"\n                >\n                </a>                ")));
              }
            }
          ...
          _this.$photoContainer.append("<div class='instagram-error'>Instagram error: ".concat(response.meta.error_message, "</div>"));

          return console.log("Instagram error: ".concat(response.meta.error_message));
        },
...
// CONCATENATED MODULE: ./source/scripts/sections/TwitterWidget.js
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function TwitterWidget_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function TwitterWidget_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function TwitterWidget_createClass(Constructor, protoProps, staticProps) { if (protoProps) TwitterWidget_defineProperties(Constructor.prototype, protoProps); if (staticProps) TwitterWidget_defineProperties(Constructor, staticProps); return Constructor; }



var TwitterWidget_TwitterWidget =
/*#__PURE__*/
function () {
  function TwitterWidget(section) {
    TwitterWidget_classCallCheck(this, TwitterWidget);
  ...
  TwitterWidget_createClass(TwitterWidget, [{
    key: "_validate",
    value: function _validate() {
      this.$tweetContainer = $('[data-twitter-tweets]', this.$el);
      this.username = $('[data-twitter-username]', this.$el).attr('data-twitter-username');
      var showRetweets = $('[data-twitter-show-retweets]', this.$el).length;
      var showImages = $('[data-twitter-show-images]', this.$el).length;
      var isInitialized = this.$el.hasClass(this.initializedClass) && this.$tweetContainer.length;
      return this._getTweets(showRetweets, showImages, isInitialized);
    }
  }, {
    key: "_getTweets",
    value: function _getTweets(showRetweets, showImages, isInitialized) {
      var _config;
      ...
      }, _defineProperty(_config, "showInteraction", false), _defineProperty(_config, "useEmoji", true), _config);
      return twitterFetcher_min_default.a.fetch(config);
    }
  }, {
    key: "_renderTweets",
    value: function _renderTweets(tweets) {
      if (tweets.length) {
        $('[data-tweet]', this.$tweetContainer).empty();

        for (var i = 0; i < tweets.length; i++) {
          var tweet = $(tweets[i]);
          $('[data-tweet]', this.$tweetContainer).append(tweet);
        }

        var media = $('.media', this.$el);
        var user = $('.user', this.$el);
        $('[data-tweet]', this.$tweetContainer).prepend(media);
        $('[data-tweet]', this.$tweetContainer).prepend(user);

        if ("".concat(this.username.toLowerCase()) !== $('[data-scribe="element:screen_name"]', this.$el).text().toLowerCase()) {
          $('[data-scribe="component:author"] > [data-scribe="element:user_link"]').prepend('\
          <svg class="retweet-svg" viewBox="0 0 32 32"> \
          <path class="path1" d="M4 10h20v6l8-8-8-8v6h-24v12h4zM28 22h-20v-6l-8 8 8 8v-6h24v-12h-4z"></path> \
          </svg>');
        }

        var timestamp = $('.timePosted', this.$el).text().split(' ');
        return $('.timePosted', this.$el).prepend("<span class='twitter-icon'>&#xF12E;</span>");
      }
    ...
    value: function _hasError(response) {
      ...
      if (response) {
        return console.log("Twitter error: ".concat(response.meta.error_message));
      }
    }
  }, {
    key: "update",
...
// CONCATENATED MODULE: ./source/scripts/sections/DynamicSocialWidgets.js
function DynamicSocialWidgets_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DynamicSocialWidgets_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DynamicSocialWidgets_createClass(Constructor, protoProps, staticProps) { if (protoProps) DynamicSocialWidgets_defineProperties(Constructor.prototype, protoProps); if (staticProps) DynamicSocialWidgets_defineProperties(Constructor, staticProps); return Constructor; }




var DynamicSocialWidgets_DynamicSocialWidgets =
/*#__PURE__*/
function () {
  function DynamicSocialWidgets(section) {
    DynamicSocialWidgets_classCallCheck(this, DynamicSocialWidgets);

    this.el = section.el;
    this.$el = $(this.el);

    if ($('[data-instagram]', this.$el).length) {
      this.instagram = new InstagramWidget({
        el: this.el
      });
    }

    if ($('[data-twitter]', this.$el).length) {
      this.twitter = new TwitterWidget_TwitterWidget({
        el: this.el
      });
    }
  }

  DynamicSocialWidgets_createClass(DynamicSocialWidgets, [{
    key: "update",
    value: function update() {
      if (this.instagram) {
...
function () {
  function DynamicSlideshow(section) {
    ...
    this.flickity = null;
    this.slideCount = this.$el.data('slideshow-slides');
  ...
  DynamicSlideshow_createClass(DynamicSlideshow, [{
    ...
    value: function _setupSlideshow() {
      var slideshowNavigation = true;
      var slideshowPagination = true;
...
var DynamicTestimonials_DynamicTestimonials =
/*#__PURE__*/
function () {
  ...
  DynamicTestimonials_createClass(DynamicTestimonials, [{
    ...
    value: function _flickity() {
      ...
      this.flickity = new Flickity(this.$testimonialsContainer[0], {
        cellAlign: 'center',
...
var DynamicVideoWithTextOverlay =
/*#__PURE__*/
function () {
...
var jquery_revealer = __webpack_require__(15);
...
var StaticNavigation_StaticNavigation =
/*#__PURE__*/
function () {
  function StaticNavigation(el) {
    StaticNavigation_classCallCheck(this, StaticNavigation);

    this.el = el;
    this.$el = $(this.el);
    this.$navigationWrapper = this.$el.find('[data-navigation-wrapper]');
    this.$navigationContent = this.$el.find('[data-navigation-content]');
    this.$body = $(document.body);
  ...
  StaticNavigation_createClass(StaticNavigation, [{
    ...
    value: function _bindEvents() {
      ...
      $('.mega-nav-list li a', this.$el).on('mouseover', function (event) {
        return _this.onListItemMouseover(event);
      });
      $('.mega-nav-list a', this.$el).on('mouseleave', function (event) {
        return _this.useDefaultImage(event);
      });
      $('.has-dropdown [data-subnav-toggle]', this.$el).on('click', function (event) {
        return _this.toggleNavTier(event);
      });
      $('[data-header-nav-toggle]', this.$el).on('click', function (event) {
        return _this.handleMobileNavigationToggle(event);
      });
      $(window).on('resize.navigation', scripts_themeUtils.debounce(this.layoutChange, 500));
      $('.has-mega-nav').on('mouseenter', function (event) {
        if (scripts_themeUtils.isSmall()) {
          return;
        }

        _this.swapMegaNavImages($('.mega-nav-image img'));

        var $dropdown = $(event.currentTarget).children('.mega-nav');
        var $navigationSubmenuToggle = $(event.currentTarget).find('.navigation-submenu-toggle');
        $dropdown.revealer('show');
        $navigationSubmenuToggle.attr('aria-expanded', true);
      });
      $('.has-mega-nav').on('mouseleave', function (event) {
        if (scripts_themeUtils.isSmall()) {
          return;
        }
      ...
      $('.has-dropdown').on('mouseenter', function (event) {
        var $dropdown = $(event.currentTarget).children('.navigation-submenu');
        var $navigationSubmenuToggle = $(event.currentTarget).find('.navigation-submenu-toggle');
        $dropdown.revealer('show');
        $navigationSubmenuToggle.attr('aria-expanded', true);
      });
      $('.has-dropdown').on('mouseleave', function (event) {
        if (scripts_themeUtils.isSmall()) {
          return;
        }
      ...
      $('.navigation-submenu').on('revealer-animating', function (event) {
        if (scripts_themeUtils.isSmall()) {
          return;
        }
    ...
    key: "_unbindEvents",
    value: function _unbindEvents() {
      $('.mega-nav-list li a', this.$el).off('mouseover');
      $('.mega-nav-list a', this.$el).off('mouseleave');
      $('.has-dropdown [data-subnav-toggle]', this.$el).off('click');
      $('[data-header-nav-toggle]', this.$el).off('click');
      $(window).off('resize.navigation');
      $('.has-mega-nav').off('mouseenter');
      $('.has-mega-nav').off('mouseleave');
      $('.has-dropdown').off('mouseenter');
      $('.has-dropdown').off('mouseleave');
      $('.navigation-submenu').off('revealer-animating');
    }
  }, {
    key: "_onSectionUnload",
    value: function _onSectionUnload(e) {
      this.unload();
    }
  }, {
    key: "layoutChange",
    value: function layoutChange(event) {
      this._bindEvents();

      this.setupNavigation(); // This is needed to explicitly check window height for Android devices

      if ($(window).height() !== this.$height) {
        if (!scripts_themeUtils.isLessThanMedium()) {
          var $navigationSubmenuToggle = $(event.currentTarget).find('.navigation-submenu-toggle');
          this.$navigationWrapper.removeClass('visible');
          $navigationSubmenuToggle.attr('aria-expanded', false);
          this.toggleMobileNavigation($navigationSubmenuToggle, 'close');
        }
      }
    }
  }, {
    key: "unload",
    value: function unload() {
      this.toggleMobileNavigation('close');

      this._unbindEvents();
    }
  }, {
    key: "_onSectionLoad",
    value: function _onSectionLoad(e) {
      this.setupNavigation();
    }
  }, {
    key: "setupNavigation",
    ...
    key: "onListItemMouseover",
    value: function onListItemMouseover(e) {
      this.swapMegaNavImages(e.currentTarget.parentNode);
    }
  }, {
    key: "swapMegaNavImages",
    value: function swapMegaNavImages(target) {
    ...
    key: "handleMobileNavigationToggle",
    value: function handleMobileNavigationToggle(event) {
      var $navigationSubmenuToggle = $(event.currentTarget).find('.navigation-submenu-toggle');
      ...
      if (this.$body.hasClass('mobile-nav-open')) {
        ...
        this.toggleMobileNavigation($navigationSubmenuToggle, 'open');
      }
    ...
    value: function toggleMobileNavigation($navigationSubmenuToggle, direction) {
      if (direction === 'open') {
        ...
        $navigationSubmenuToggle.attr('aria-expanded', false); // Close opened menus on navigation close

        this.$navigationContent.find('.has-dropdown-open').removeClass('has-dropdown-open').find('.navigation-submenu-visible').removeClass('navigation-submenu-visible');
      }
    }
  }, {
    key: "toggleNavTier",
    value: function toggleNavTier(e) {
      if (this.$navigationContent.hasClass('navigation-mobile')) {
        e.preventDefault();
      }

      var $target = $(e.currentTarget);
      var $trigger = $target.closest('a');
      var $parentEl = $trigger.parent('li');
      var $targetLinkList = $("ul[data-linklist='".concat($trigger.data('linklist-trigger'), "']"), this.$el);
    ...
    key: "closeSiblingTiers",
    value: function closeSiblingTiers($openMenu) {
      var _this2 = this;

      $openMenu.siblings('.has-dropdown-open').each(function (index, el) {
        var $parentEl = $(el);
        var $targetLinkList = $parentEl.find('.navigation-submenu-visible');
    ...
    key: "openNavTier",
    value: function openNavTier(options) {
      var $parentEl = options.$parentEl,
          $targetLinkList = options.$targetLinkList;
    ...
    key: "closeNavTier",
    value: function closeNavTier(options) {
      var $parentEl = options.$parentEl,
          $targetLinkList = options.$targetLinkList;
    ...
    key: "useDefaultImage",
    value: function useDefaultImage(e) {
...
function () {
  function StaticHeader(section) {
    ...
    this.$window = $(window);
    this.$body = $(document.body);
    this.$header = this.$el.find('[data-section-type="header"]');
    this.$mainHeader = this.$el.find('[data-header-main]');
    this.$headerContent = this.$el.find('[data-header-content]');
    this.$navigationWrapper = this.$el.find('[data-navigation-wrapper]');
    this.$navigationContent = this.$el.find('[data-navigation-content]');
    this.$branding = this.$el.find('[data-header-branding]');
    this.$headerTools = this.$el.find('.header-tools');
    this.$headerRight = this.$el.find('[data-header-content-right]');
    this.$headerSearch = this.$el.find('[data-header-search]');
    this.$headerSearchSubmit = this.$el.find('[data-header-search-button]');
    this.$headerSearchClose = this.$el.find('[data-header-search-button-close]');
    this.cachedHeight = 0;
    ...
    this.navigation = new StaticNavigation_StaticNavigation(this.el);
  ...
  StaticHeader_createClass(StaticHeader, [{
    ...
    value: function onSectionDeselect() {
      this.navigation.toggleMobileNavigation('close');
    }
  }, {
    key: "onSectionUnload",
    value: function onSectionUnload() {
...
function () {
  ...
  StaticCollection_createClass(StaticCollection, [{
    ...
    value: function filterCollection(event) {
      ...
      if (tag === 'all') {
        window.location.href = "/collections/".concat(url);
      } else {
        window.location.href = "/collections/".concat(url, "/").concat(tag);
      }
    }
  }, {
    key: "sortCollection",
  ...
  StaticCart_createClass(StaticCart, [{
    ...
    value: function _validate() {
      ...
      return Shopify.onError = function (XMLHttpRequest) {
        return _this2.handleErrors(XMLHttpRequest);
      };
    }
  }, {
    ...
    value: function shippingCalculator() {
      ...
      var selectableOptions = $('.cart-shipping-calculator select');
      setTimeout(function () {
        selectableOptions.map(function (index, select) {
          return _this3.updateShippingLabel(select);
        });
      }, 1);
      /* TODO: A race condition here prevents the state/province select
       * from updating when the country changes (since at least v4.0.0).
       * I've added a timeout as a temporary fix, but we should find a
       * more reliable solution.
       * */

      selectableOptions.change(function (e) {
        selectableOptions.each(function (index, select) {
          setTimeout(function () {
            _this3.updateShippingLabel(select);
          }, 1);
        });
      });
    }
    ...
    value: function calculateShipping(auto) {
      var shippingAddress;
      var shippingCalculatorResponse = $('.cart-shipping-calculator-response', this.$el);
      shippingCalculatorResponse.empty().append("<p class='shipping-calculator-response message'/><ul class='shipping-rates'/>");
      var ratesFeedback = $('.shipping-calculator-response');
      $('.get-rates', this.$el).val(Theme.shippingDisabled);

      if (auto) {
        shippingAddress = Theme.customerAddress;
      } else {
        shippingAddress = {
          zip: $('.address-zip', this.$el).val() || '',
          country: $('.address-country', this.$el).val() || '',
          province: $('.address-province', this.$el).val() || ''
        };
      }
      ...
      Shopify.getCartShippingRatesForDestination(shippingAddress, function (rates) {
        ...
        if (rates.length > 1) {
          ...
          response = Theme.shippingCalcMultiRates.replace('**address**', address).replace('**number_of_rates**', rates.length).replace('**rate**', "<span class='money'>".concat(firstRate, "</span>"));
        ...
        for (var i = 0; i < rates.length; i++) {
          ...
          $('.shipping-rates').append("<li>".concat(rateValues, "</li>"));
        }

        return $('.get-rates').val(Theme.shippingButton);
      });
    }
  }, {
    key: "handleErrors",
...
var StaticBlogMasonry_StaticBlogMasonry =
/*#__PURE__*/
function () {
...
var StaticCollectionsList_StaticCollectionsList =
/*#__PURE__*/
function () {
...
var ProductSection_ProductSection =
/*#__PURE__*/
function () {
...
function () {
  function ThemeView() {
    ...
    sections.register('dynamic-social-widgets', function (section) {
      return new DynamicSocialWidgets_DynamicSocialWidgets(section);
    });
    ...
    this.hasCurrencySwitcher = $('.currency-switcher').length > 0;

    if (this.hasCurrencySwitcher) {
      this.currencySwitcherSelector = '[data-currency-converter]';
      this.$switcher = $(this.currencySwitcherSelector);
  ...
  grid_createClass(ThemeView, [{
    ...
    value: function currencySwitcher() {
      var currencyData = JSON.parse($('[data-currency-data]').html());
      dist_default.a.init({
        switcherSelector: this.currencySwitcherSelector,
        priceSelector: this.priceSelector,
        shopCurrency: currencyData.shopCurrency,
        defaultCurrency: currencyData.defaultCurrency,
        displayFormat: currencyData.displayFormat,
        moneyFormat: currencyData.moneyFormat,
        moneyFormatNoCurrency: currencyData.moneyFormatNoCurrency,
        moneyFormatCurrency: currencyData.moneyFormatCurrency
      });
      this.$switcher.trigger('updateCurrency');
      $('.selected-currency').text(this.$switcher.val());
      this.moveCurrencyConverter();
    }
  }, {
    key: "moveCurrencyConverter",
    value: function moveCurrencyConverter() {
      var $currencyWrapper = $('.currency-wrapper');

      if (scripts_themeUtils.isLessThanLarge()) {
        $currencyWrapper.detach().insertAfter('.navigation-menu').addClass('mobile-currency-wrapper');
      } else {
        $currencyWrapper.detach().removeClass('mobile-currency-wrapper').appendTo('[data-header-currency-converter]');
      }
    }
  }, {
    key: "eventBinding",
    value: function eventBinding() {
      ...
      if (this.$switcher) {
        this.$switcher.on('change', function (event) {
          dist_default.a.setCurrency(event.currentTarget.value);
          $('.selected-currency').text(_this2.$switcher.val());
        });
      }

      $(window).on('resize.currency', scripts_themeUtils.debounce(this.moveCurrencyConverter, 100)); // This is required to fix an iOS10 bug for Flickity.
      ...
      $(window).on('dragStart', function (event) {
        ...
        var flickity = Flickity.data($flickityEnabledEl[0]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=grid.js.map?1554749089437